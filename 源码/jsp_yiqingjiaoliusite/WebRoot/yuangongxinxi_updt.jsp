...
%>
  <form  action="yuangongxinxi_updt.jsp?f=f&id=<%=mmm.get("id")%>"  name="form1" class="form"  onsubmit="return checkform();">
  修改员工信息:
  <br><br>

   <table width="100%" class="table" >

     <tr><td>员工工号：</td><td><input name='yuangonggonghao' type='text' id='yuangonggonghao' value='<%= mmm.get("yuangonggonghao")%>' class="hdladd" readonly="readonly" /></td></tr>
