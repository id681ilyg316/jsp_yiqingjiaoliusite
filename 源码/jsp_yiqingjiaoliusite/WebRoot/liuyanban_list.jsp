...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
  <tr>
	...
	<td style="display:none" width="4%" bgcolor='#A4B6D7'>头像</td>
	<td width="10%" bgcolor='#A4B6D7'>QQ</td><td width="11%" bgcolor='#A4B6D7'>邮箱</td><td width="16%" bgcolor='#A4B6D7'>电话</td>
  ...
  <tr>
    <td><%=i %></td>
    <td><%=map.get("cheng") %></td>
	<td style="display:none"><%= map.get("xingbie") %></td>
	<td><%= map.get("QQ") %></td><td><%= map.get("youxiang") %></td><td><%= map.get("dianhua") %></td>
