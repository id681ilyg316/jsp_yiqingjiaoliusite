	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(ac.equals("login"))
		{
			...
			if(!pagerandom.equals(random)&&request.getParameter("a")!=null)
			{
				...
				String sql1="";
				if (utype.equals("注册用户")){sql1 = "select * from yonghuzhuce where yonghuming='"+username+"' and mima='"+password+"' ";}
				if (utype.equals("员工")){sql1 = "select * from yuangongxinxi where yuangonggonghao='"+username+"' and mima='"+password+"' ";}
				//quxanxiaxndexnglxu
		...
		if(ac.equals("adminlogin"))
		{
			...
			if(userlist1.size()==1)
			{
				...
				{
					request.getSession(). setAttribute("cx", utype); 
					request.getSession(). setAttribute("qd",  userlist1.get(0).get("qidu")); 
				}
